 ...
 */
public class ActivityPilihBarang extends Activity {
    ListView lvDaftar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvDaftar.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        lvDaftar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public class LoadDaftar extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ActivityPilihBarang.this);
